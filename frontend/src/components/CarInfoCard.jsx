...
export function CarInfoCard({ car, user, onRent, onClose }) {
    ...
    return (
        <div className="position-fixed top-0 start-0 vh-100 vw-100 d-flex justify-content-center align-items-center" 
             style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 1050 }}
             onClick={onClose}>
            
            <div className="bg-white p-5 rounded-4 position-relative" style={{ minWidth: '400px', maxWidth: '800px' }} onClick={(e) => e.stopPropagation()}>
                ...
                <div className="d-flex justify-content-between align-items-center p-3">
                    <h2 className="fw-bold">{car.marka} {car.model}</h2>
                    <span
                ...
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-12 col-md-7 text-center order-md-2">
                    ...
                    <div className="col-12 col-md-5 order-md-1">                    
                        ...
                        <div className="p-3 bg-gray rounded-3 shadow-sm">
                            <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                <span className="text-muted"><i className="bi bi-calendar-event me-2"></i>Rok produkcji:</span>
                                <span className="fw-semibold">{car.rok_produkcji}</span>
                            </div>

                            <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                <span className="text-muted"><i className="bi bi-calendar-event me-2"></i>Kategoria: </span>
                                <span className="fw-semibold">{car.kategoria}</span>
                            </div>
                            
                            <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                <span className="text-muted"><i className="bi bi-fuel-pump me-2"></i>Rodzaj paliwa:</span>
                                <span className="fw-semibold text-capitalize">{car.rodzaj_paliwa}</span>
                            </div>
                            
                            <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                <span className="text-muted"><i className="bi bi-gear me-2"></i>Skrzynia biegów:</span>
                                <span className="fw-semibold text-capitalize">{car.skrzynia_biegow}</span>
                            </div>
                            
                            <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                <span className="text-muted"><i className="bi bi-people me-2"></i>Liczba miejsc:</span>
                                <span className="fw-semibold">{car.liczba_miejsc}</span>
                            </div>

                            <div className="d-flex justify-content-between align-items-center pt-2">
                                <span className="text-muted"><i className="bi bi-cash-coin me-2"></i>Cena za dobę:</span>
